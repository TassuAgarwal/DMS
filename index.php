...
<?php include 'header.php' ?>
         ...
         <div class="row">
            ...
            <div class="col-md-6">
               <div class="about_text">
                  <h3>Dishu Medical System</h3>
                  <p>At DMS, we are dedicated to providing cutting-edge medical solutions, ensuring quality healthcare services for individuals, families, and communities. From advanced diagnostics to personalized treatment plans, we bring excellence and compassion together. Our mission is to enhance lives through quality healthcare and groundbreaking medical research.</p>

                  <h4>Why Choose Us ?</h4>
                  <ul>
                     <li><b>Telemedicine</b> Consult top doctors from the comfort of your home.</li>
                     <li><b>General Medicine</b> Expert care for routine checkups, and chronic conditions.</li>
                     <li><b>Pharmacy Services</b> On-site and online prescription fulfillment.</li>
                     <li><b>Emergency Services</b> 24/7 support for urgent medical needs.</li>
                     <li><b>Specialized Treatments</b> Cardiology, Neurology, Orthopedics, and more.</li>
                     <li><b>Diagnostics & Laboratory</b> Accurate tests and imaging services.</li>
                  </ul>

                  <a class="read_more mt-4" href="about.html">Read More</a>
               </div>
            </div>
            <div class="col-md-6">
               <div class="about_img">
                  <figure><img src="images/aboutimg.jpg" alt="#" /></figure>
               </div>
            </div>
         </div>
      </div>
   ...
   <div class="Marquee">
      <div class="Marquee-content">
         <div class="Marquee-tag"><img src="images/logos/1.png" alt=""></div>
         <div class="Marquee-tag"><img src="images/logos/2.png" alt=""></div>
         <div class="Marquee-tag"><img src="images/logos/3.png" alt=""></div>
         <div class="Marquee-tag"><img src="images/logos/4.png" alt=""></div>
         <div class="Marquee-tag"><img src="images/logos/5.png" alt=""></div>
         <div class="Marquee-tag"><img src="images/logos/6.png" alt=""></div>
         <div class="Marquee-tag"><img src="images/logos/7.png" alt=""></div>
         <div class="Marquee-tag"><img src="images/logos/8.png" alt=""></div>
         <div class="Marquee-tag"><img src="images/logos/9.png" alt=""></div>
         <div class="Marquee-tag"><img src="images/logos/10.png" alt=""></div>
      </div>
   </div>
